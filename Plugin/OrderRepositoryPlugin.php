...
class OrderRepositoryPlugin
{
    ...
    public function afterSave(
        ...
        /** @var \SwedbankPay\Payments\Model\Order $swedbankPayOrder */
        $swedbankPayOrder = $this->orderFactory->create();

        $swedbankPayOrder->setState($swedbankPayQuote->getState());
        $swedbankPayOrder->setPaymentId($swedbankPayQuote->getPaymentId());
        $swedbankPayOrder->setPaymentIdPath($swedbankPayQuote->getPaymentIdPath());
        $swedbankPayOrder->setInstrument($swedbankPayQuote->getInstrument());
